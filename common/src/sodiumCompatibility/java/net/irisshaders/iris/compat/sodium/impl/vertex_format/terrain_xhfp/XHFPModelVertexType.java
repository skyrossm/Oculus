...
public class XHFPModelVertexType implements ChunkVertexType {
	...
	public static final GlVertexFormat<ChunkMeshAttribute> VERTEX_FORMAT = GlVertexFormat.builder(ChunkMeshAttribute.class, STRIDE)
		.addElement(ChunkMeshAttribute.POSITION_HI, 0, IrisGlVertexAttributeFormat.UNSIGNED_2_10_10_10_REV, 4, false, false)
		.addElement(ChunkMeshAttribute.POSITION_LO, 4, IrisGlVertexAttributeFormat.UNSIGNED_2_10_10_10_REV, 4, false, false)
		.addElement(ChunkMeshAttribute.COLOR, 8, GlVertexAttributeFormat.UNSIGNED_BYTE, 4, true, false)
		.addElement(ChunkMeshAttribute.TEXTURE, 12, IrisGlVertexAttributeFormat.SHORT, 2, false, false)
